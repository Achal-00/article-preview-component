...
const Footer = () => {
  ...
  useEffect(() => {
    if (visible) {
      ...
      document.querySelector(".share-icon").style.background =
        "var(--desaturated-dark-blue)";
      document.querySelector(".share-icon path").style.fill = "var(--white)";
    } else {
      document.querySelector(".overlay").style.display = "none";
      document.querySelector(".share-icon").style.background =
        "var(--light-greyish-blue)";
      document.querySelector(".share-icon path").style.fill = "#6E8098";
    }
  }, [visible]);
